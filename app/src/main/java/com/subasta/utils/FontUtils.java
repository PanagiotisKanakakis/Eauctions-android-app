...
public class FontUtils {
    ...
    /* JADX WARNING: type inference failed for: r1v9, types: [java.io.OutputStream, java.io.Closeable, java.io.FileOutputStream] */
    ...
    public static Typeface getTypefaceFromRaw(Context r7, int r8) {
        ...
        L_0x0083:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.subasta.utils.FontUtils.getTypefaceFromRaw(android.content.Context, int):android.graphics.Typeface");
    }
