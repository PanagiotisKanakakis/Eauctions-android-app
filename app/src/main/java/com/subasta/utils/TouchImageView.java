...
public class TouchImageView extends AppCompatImageView {
    ...
    /* renamed from: com.subasta.utils.TouchImageView$1 */
...
//        static {
//            throw new UnsupportedOperationException("Method not decompiled: com.subasta.utils.TouchImageView.C23001.<clinit>():void");
//        }
    }
    ...
    private class Fling implements Runnable {
        ...
        Fling(int i, int i2) {
            ...
            TouchImageView.this.matrix.getValues(TouchImageView.this.f1320m);
            int i7 = (int) TouchImageView.this.f1320m[2];
            int i8 = (int) TouchImageView.this.f1320m[5];
    ...
    private class GestureListener extends SimpleOnGestureListener {
        ...
        /* synthetic */ GestureListener(TouchImageView touchImageView, C23001 r2) {
            this();
        }
    ...
    private class PrivateOnTouchListener implements OnTouchListener {
        ...
        /* synthetic */ PrivateOnTouchListener(TouchImageView touchImageView, C23001 r2) {
            this();
        }
        ...
        public boolean onTouch(android.view.View r8, MotionEvent r9) {
            /*
                r7 = this;
                com.subasta.utils.TouchImageView r0 = com.subasta.utils.TouchImageView.this
                ...
                float r2 = r9.getY()
                r0.<init>(r1, r2)
                com.subasta.utils.TouchImageView r1 = com.subasta.utils.TouchImageView.this
                com.subasta.utils.TouchImageView$State r1 = r1.state
                com.subasta.utils.TouchImageView$State r2 = com.subasta.utils.TouchImageView.State.NONE
                r3 = 1
                if (r1 == r2) goto L_0x003e
                com.subasta.utils.TouchImageView r1 = com.subasta.utils.TouchImageView.this
                com.subasta.utils.TouchImageView$State r1 = r1.state
                com.subasta.utils.TouchImageView$State r2 = com.subasta.utils.TouchImageView.State.DRAG
                if (r1 == r2) goto L_0x003e
                com.subasta.utils.TouchImageView r1 = com.subasta.utils.TouchImageView.this
                com.subasta.utils.TouchImageView$State r1 = r1.state
                com.subasta.utils.TouchImageView$State r2 = com.subasta.utils.TouchImageView.State.FLING
            ...
            L_0x004e:
                ...
                float r4 = r4.y
                float r2 = r2 - r4
                com.subasta.utils.TouchImageView r4 = com.subasta.utils.TouchImageView.this
                int r5 = r4.viewWidth
                float r5 = (float) r5
                com.subasta.utils.TouchImageView r6 = com.subasta.utils.TouchImageView.this
            ...
            L_0x00a0:
                com.subasta.utils.TouchImageView r0 = com.subasta.utils.TouchImageView.this
                com.subasta.utils.TouchImageView$State r1 = com.subasta.utils.TouchImageView.State.NONE
                r0.setState(r1)
                goto L_0x00c5
            L_0x00a8:
                android.graphics.PointF r1 = r7.last
                r1.set(r0)
                com.subasta.utils.TouchImageView r0 = com.subasta.utils.TouchImageView.this
                com.subasta.utils.TouchImageView$Fling r0 = r0.fling
            ...
            L_0x00be:
                com.subasta.utils.TouchImageView r0 = com.subasta.utils.TouchImageView.this
                com.subasta.utils.TouchImageView$State r1 = com.subasta.utils.TouchImageView.State.DRAG
                r0.setState(r1)
            L_0x00c5:
                com.subasta.utils.TouchImageView r0 = com.subasta.utils.TouchImageView.this
                ...
                r0.onTouch(r8, r9)
            L_0x00df:
                com.subasta.utils.TouchImageView r8 = com.subasta.utils.TouchImageView.this
                com.subasta.utils.TouchImageView$OnTouchImageViewListener r8 = r8.touchImageViewListener
            ...
            L_0x00f0:
                return r3
            */
            throw new UnsupportedOperationException("Method not decompiled: com.subasta.utils.TouchImageView.PrivateOnTouchListener.onTouch(android.view.View, android.view.MotionEvent):boolean");
        }
    }
    ...
    private class ScaleListener extends SimpleOnScaleGestureListener {
        ...
        /* synthetic */ ScaleListener(TouchImageView touchImageView, C23001 r2) {
            this();
        }
    ...
    private void savePreviousImageValues() {
        ...
        if (matrix2 != null && this.viewHeight != 0 && this.viewWidth != 0) {
            matrix2.getValues(this.f1320m);
            this.prevMatrix.setValues(this.f1320m);
    ...
    public Parcelable onSaveInstanceState() {
        ...
        this.matrix.getValues(this.f1320m);
        bundle.putFloatArray("matrix", this.f1320m);
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        if (parcelable instanceof Bundle) {
            ...
            this.f1320m = bundle.getFloatArray("matrix");
            this.prevMatrix.setValues(this.f1320m);
    ...
    public void setZoom(float f, float f2, float f3, ScaleType scaleType) {
        ...
        this.matrix.getValues(this.f1320m);
        this.f1320m[2] = -((f2 * getImageWidth()) - (((float) this.viewWidth) * 0.5f));
        this.f1320m[5] = -((f3 * getImageHeight()) - (((float) this.viewHeight) * 0.5f));
        this.matrix.setValues(this.f1320m);
        fixTrans();
        setImageMatrix(this.matrix);
    }
    ...
    public void fixScaleTrans() {
        ...
        if (imageWidth < ((float) i)) {
            this.f1320m[2] = (((float) i) - getImageWidth()) / 2.0f;
        }
        float imageHeight = getImageHeight();
        int i2 = this.viewHeight;
        if (imageHeight < ((float) i2)) {
            this.f1320m[5] = (((float) i2) - getImageHeight()) / 2.0f;
        }
        this.matrix.setValues(this.f1320m);
    }
    ...
    private void fitImageToView() {
        ...
        if (drawable != null && drawable.getIntrinsicWidth() != 0 && drawable.getIntrinsicHeight() != 0 && this.matrix != null && this.prevMatrix != null) {
            ...
            int i = C23001.$SwitchMap$android$widget$ImageView$ScaleType[this.mScaleType.ordinal()];
            if (i != 1) {
                if (i != 2) {
                    if (i == 3) {
            ...
            if (isZoomed() || this.imageRenderedAtLeastOnce) {
                ...
                this.prevMatrix.getValues(this.f1320m);
                float[] fArr = this.f1320m;
    ...
    private void translateMatrixAfterRotate(int i, float f, float f2, float f3, int i2, int i3, int i4) {
        ...
        if (f3 < f4) {
            ...
            this.f1320m[i] = -((f3 - f4) * 0.5f);
        } else {
            this.f1320m[i] = -((((Math.abs(f) + (((float) i2) * 0.5f)) / f2) * f3) - (f4 * 0.5f));
        }
    }
    ...
    public PointF transformCoordBitmapToTouch(float f, float f2) {
        this.matrix.getValues(this.f1320m);
        return new PointF(this.f1320m[2] + (getImageWidth() * (f / ((float) getDrawable().getIntrinsicWidth()))), this.f1320m[5] + (getImageHeight() * (f2 / ((float) getDrawable().getIntrinsicHeight()))));
    }
