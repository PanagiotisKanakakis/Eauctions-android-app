...
public class ActivityGetAllRatingBindingImpl extends ActivityGetAllRatingBinding {
    @Nullable
    ...
    static {
        ...
        sViewsWithIds.put(C2037R.C2039id.icRatBack, 3);
        sViewsWithIds.put(C2037R.C2039id.tvTitleRat, 4);
        sViewsWithIds.put(C2037R.C2039id.simpleSwipeRefreshLayout, 5);
        sViewsWithIds.put(C2037R.C2039id.rvAllRating, 6);
        sViewsWithIds.put(C2037R.C2039id.nodata, 7);
    }

    public ActivityGetAllRatingBindingImpl(@Nullable androidx.databinding.DataBindingComponent dataBindingComponent, @NonNull View view) {
        this(dataBindingComponent, view, mapBindings(dataBindingComponent, view, 8, sIncludes, sViewsWithIds));
    }

    private ActivityGetAllRatingBindingImpl(androidx.databinding.DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
