...
public class ActivityAutionAllBindingImpl extends ActivityAutionAllBinding {
    @Nullable
    ...
    public ActivityAutionAllBindingImpl(@Nullable androidx.databinding.DataBindingComponent dataBindingComponent, @NonNull View view) {
        this(dataBindingComponent, view, mapBindings(dataBindingComponent, view, 3, sIncludes, sViewsWithIds));
    }

    private ActivityAutionAllBindingImpl(androidx.databinding.DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
    ...
    public boolean hasPendingBindings() {
        ...
        L_0x0018:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.subasta.databinding.ActivityAutionAllBindingImpl.hasPendingBindings():boolean");
    }
